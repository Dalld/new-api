...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&CommissionRecord{},
		&GroupProbeResult{},
		&PublicStatusProbeResult{},
		&PublicStatusProbeLease{},
		&QuotaData{},
		&Task{},
		&Model{},
		&Vendor{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&GroupProbeResult{}, "GroupProbeResult"},
		{&PublicStatusProbeResult{}, "PublicStatusProbeResult"},
		{&PublicStatusProbeLease{}, "PublicStatusProbeLease"},
		{&QuotaData{}, "QuotaData"},
		{&Task{}, "Task"},
		{&Model{}, "Model"},
		{&Vendor{}, "Vendor"},
